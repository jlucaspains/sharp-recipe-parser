...
const converters = new Map<string, (input: number) => number>(DefaultEnglish.unitConversions.converters);
const defaultConversions = new Map<string, string[]>(DefaultEnglish.unitConversions.defaultConversions);
