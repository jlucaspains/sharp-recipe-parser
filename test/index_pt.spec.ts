...
describe("Parse ingredient PT", () => {
  const table = [
    ...
    ["142g farinha de pao", 142, "142", "grama", "farinha de pao", ""],
    ["142g farinha de pao", 142, "142", "grama", "farinha de pao", ""],
    ["1 copo de cenouras, cortadas pequenas", 1, "1", "copo", "cenouras", "cortadas pequenas"],
    ...
    ["1/2 quilograma de carne moida", 0.5, "1/2", "quilograma", "carne moida", ""],
    ...
    ["1 copo (120g) farinha, peneirada", 1, "1", "copo", "farinha", "peneirada"],
    ["1 copo farinha (integral), peneirada", 1, "1", "copo", "farinha", "peneirada"],
